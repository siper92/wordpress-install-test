		...
		<?php
			...
			if (!is_singular() && !empty($wp_shop_woocommerce_embeds)) {
				foreach ($wp_shop_woocommerce_embeds as $wp_shop_woocommerce_embed) {
					if (strpos($wp_shop_woocommerce_embed, 'audio') !== false && !in_array($wp_shop_woocommerce_embed, $wp_shop_woocommerce_displayed_embeds)) {
						$wp_shop_woocommerce_displayed_embeds[] = $wp_shop_woocommerce_embed;
						?>
